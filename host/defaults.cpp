...
//     openttd-defaults.ld pins to image offset 0x800. It ships with the
...
#ifdef __ELF__
__asm__ (
    "\t.section .ottd.entry, \"ax\", %progbits\n"
    "\t.globl _ottd_entry\n"
    "_ottd_entry:\n"
    "\tb _start\n"
    "\t.previous\n"
...
#define DEFAULTS_BLOCK_PLACEMENT \
    __attribute__ ((section (".ottd.defaults"), used, aligned (8)))
#else
