...
// through to the game untouched — and OpenTTD has a full command line of its
// own, so this is how a boot asks for a different resolution, a different
// blitter or a saved game to load straight into.
//
// An empty block, or an image nobody ever wrote to, appends nothing at all.
//
#ifndef _openttd_defaults_h
#define _openttd_defaults_h
